...
Shared chronology, titles, metrics, project status, presentation inventory, training inventory, headline, and Summary must remain identical. Only selected coursework, skill selection/order, project priority, PDF metadata, footer label, and output filename may vary by program.
