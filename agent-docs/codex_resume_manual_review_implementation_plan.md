...
\begin{cvitems}
  ...
  \item Achieved 0.9724 ROC AUC with the larger DNN, unexpectedly near the lab GNN baseline's 0.9751; coauthored the \href{https://github.com/NotsoJharedtrollOx17/Using_ML_for_Particle_Tracking_at_LHC}{code and report} and presented at UC San Diego and Instituto Tecnol\'ogico de Tijuana.
\end{cvitems}
```
